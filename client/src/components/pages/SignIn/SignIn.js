...
function SignIn({ classes, signin, isAuthenticated, error }) {
	...
	const handleInput = event => {
		setLogin({
			...login,
			[event.target.name]: event.target.type === 'checkbox' ? !remember : event.target.value,
		});
	};
				...
				<Grid container spacing={16}>
					...
					<Grid item xs={12} md={6}>
						<div className={classes.innerWrapper}>
							...
							<Typography variant="body2" className={classes.description}>
								Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim omnis, asperiores numquam
								ipsa labore rerum saepe necessitatibus molestias expedita cupiditate officiis minima
								veniam ullam pariatur ea, vitae inventore dignissimos perspiciatis?
							</Typography>
					...
					<Grid item xs={12}>
						<div className={classes.signInFooter}>
							<Typography component="p" variant="body2" className={classes.signInFooterContent}>
